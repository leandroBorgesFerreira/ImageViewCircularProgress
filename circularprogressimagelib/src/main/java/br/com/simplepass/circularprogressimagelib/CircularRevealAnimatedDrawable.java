...
public class CircularRevealAnimatedDrawable extends Drawable implements Animatable {
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        bitMapXOffset =(float) (((mAnimatedView.getRight() - mAnimatedView.getLeft()) - bitMapWidth)/2);
        bitMapYOffset =(float) (((mAnimatedView.getBottom() - mAnimatedView.getTop()) - bitMapHeight)/2);
